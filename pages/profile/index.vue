...
<template>
    ...
    <div v-else-if="editMode" id="edit-pane">
        <table id="profile-table">
            <tr>
                <th>姓&emsp;(例: 市川)</th>
                <td><input v-model="user.last_name" placeholder="ここに入力" type="text"></td>
            </tr>
            <tr>
                <th>名&emsp;(例: 詩恩)</th>
                <td><input v-model="user.first_name" placeholder="ここに入力" type="text"></td>
            </tr>
            <tr>
                <th>学籍番号&emsp;(例: 2164789)</th>
                <td><input v-model="user.student_id" placeholder="ここに入力" type="text"></td>
            </tr>
        </table>
